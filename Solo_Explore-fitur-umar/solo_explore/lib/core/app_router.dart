...
import '../screens/register_admin_kuliner.dart'; // 🟢 1. IMPORT FILE REGISTRASI MITRA KULINER
...
class AppRouter {
  ...
  // 🟢 2. TAMBAHKAN STRING ROUTE DI SINI AGAR BISA DIBACA LOGIN SCREEN
  static const String registerAdminKuliner = '/register-admin-kuliner'; 
  
  static const String home = '/home';
  
  // 🛠️ UBAH rutenya di sini menjadi /destination-detail agar sinkron dengan MapScreen
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      // 🟢 3. TAMBAHKAN BLOK CASE INI UNTUK MENANGANI NAVIGASINYA
      case registerAdminKuliner:
        return MaterialPageRoute(builder: (_) => const RegisterAdminKuliner());
        
      case home:
        return MaterialPageRoute(builder: (_) => const MainShell());
      case destinationDetail:
        // Menangkap data slug dengan aman agar tidak crash
        final args = settings.arguments;
        final String slug = args is String ? args : '';
        return MaterialPageRoute(
          builder: (_) => DestinationDetailScreen(slug: slug),
          settings: settings, // Ditambahkan agar URL di browser ikut rapi
        );
      case culinaryDetail:
