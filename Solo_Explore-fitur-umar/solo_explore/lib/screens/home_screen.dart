  ...
  Future<void> _loadData() async {
    try {
      ...
      if (userInterest == null) {
        userInterest = 'wisata-alam'; 
      }

      final recommendations = await apiService.getPersonalizedRecommendations(userInterest);
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        location,
                        style: GoogleFonts.beVietnamPro(fontSize: 12, color: AppColors.onSurfaceVariant),
                      ),
                    ],
                  ),
                ],
...
// 🟢 FIX UTAH: Sekarang dikembalikan menjadi StatelessWidget yang stabil
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        icon: Icon(
                          initialBookmarked ?? false ? Icons.bookmark : Icons.bookmark_outline,
                          color: AppColors.primary,
                        ),
                        onPressed: () async {
                          if (culinaryId == null) return;
                          final success = await ApiService().toggleBookmark('culinary', culinaryId!);
                          if (success) {
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        '• $reviews',
                        style: GoogleFonts.beVietnamPro(fontSize: 10, color: AppColors.onSurfaceVariant),
                      ),
                    ],
                  ),
                ],
