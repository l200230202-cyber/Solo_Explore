        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="description" rows="4" required 
                    class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('description', $culinary->description) }}</textarea>
            ...
            <div>
                ...
                <input type="text" name="opening_hours" 
                    class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    value="{{ old('opening_hours', $culinary->opening_hours) }}">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="menu_items" rows="3"
                    class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('menu_items', $culinary->menu_items) }}</textarea>
