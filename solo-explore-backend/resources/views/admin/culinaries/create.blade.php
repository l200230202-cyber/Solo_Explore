    ...
    <form action="{{ route('admin.culinaries.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-3">
                    <div class="flex gap-4">
                        <label class="flex items-center">
                            <input type="radio" name="image_type" value="upload" checked class="mr-2" onchange="toggleImageInputCulinary()">
                            Upload File
                        </label>
                        <label class="flex items-center">
                            <input type="radio" name="image_type" value="url" class="mr-2" onchange="toggleImageInputCulinary()">
                            URL Gambar
                        </label>
                    </div>
                    <input type="file" name="image" id="image_upload_culinary" accept="image/*"
                        class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <input type="url" name="image_url" id="image_url_culinary" placeholder="https://example.com/image.jpg"
            ...
            function toggleImageInputCulinary() {
                ...
                const uploadInput = document.getElementById('image_upload_culinary');
                const urlInput = document.getElementById('image_url_culinary');
            ...
            <div>
                ...
                <input type="text" name="price_range" placeholder="Rp 10.000 - Rp 50.000"
                    class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div>
                ...
                <input type="text" name="opening_hours" placeholder="08:00 - 22:00"
                    class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="menu_items" rows="3" placeholder="Nasi Goreng, Mie Ayam, Es Teh, dll"
                    class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('menu_items') }}</textarea>
